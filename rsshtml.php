...
$feedTitle = "Latest HTML Tutorials Added";
$rssVersion = 2.0;
...
$query = "SELECT * FROM `html` WHERE `aprove`='Yes' ORDER BY `id` DESC LIMIT 10";
// execute the query
...
$rss .= "<link>http://tutorials.vufu.net/html_tutorial.php?id=" . $row['id'] . "</link>\r\n";
