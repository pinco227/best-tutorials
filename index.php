...
<br><textarea class="style1" cols="50" rows="3"><script type="text/javascript" language="javascript" scr="' . $siteurl . '/banner3.js"></script></textarea></center></p><br>';
	...
	case 'search';
		...
		if ($_POST['tut'] == 'css') {
			...
			$rezultatsearchcss = mysqli_query($conexiune, $cerereSQLsearchcss);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
			...
			$rezultatsearchhtml = mysqli_query($conexiune, $cerereSQLsearchhtml);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
			...
			$rezultatsearchps = mysqli_query($conexiune, $cerereSQLsearchps);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
			...
			$rezultatsearchphp = mysqli_query($conexiune, $cerereSQLsearchphp);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
	...
	case 'links';
		...
		$rezultate_maxime = 25;
		$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT COUNT(*) as Num FROM `banner`'));
		...
		if ($intrari_totale == 0) echo 'No Links Added Yet...';
			...
			$cerereSQL = mysqli_query($conexiune, 'SELECT * FROM `banner` WHERE aprove="Yes" ORDER by ' . $_SESSION['sort'] . ' ' . $_SESSION['fel'] . ' LIMIT ' . $from . ', ' . $rezultate_maxime . ' ');
			...
			if ($pagina > $pagini_totale) echo 'Page cannot find';
				...
				if ($pagini_totale > 0) {
					...
					while ($rand = mysqli_fetch_assoc($cerereSQL)) {
						echo '  <tr>
...
<td><tt> Mesaj: <br><br> ' . $_POST['mesaj'] . ' </tt></td>
	...
	case '';
		...
		$cerereSQLcss = mysqli_query($conexiune, 'SELECT * FROM `css` WHERE aprove="Yes" ORDER BY `id` DESC LIMIT 5');

		echo '<br><h5 align="left">:: Last 5 CSS Stylesheets Tutorials Added</h5>';
		echo '<table border=0 cellspacing="2" cellpadding="2" width="90%" align="center">';
		while ($rand = mysqli_fetch_assoc($cerereSQLcss)) {
			$width = $rand['rd'] * 10;
			echo '<tr>
<td width="40" height="40" rowspan="2" class="display"><img src="' . $siteurl . '/images/css.gif" width="40" height="40"></td>
<td colspan="2" class="display"><b><a href="' . $siteurl . '/css_tutorial.php?id=' . $rand['id'] . '" target="_blank">' . $rand['title'] . '</a></b> - ' . $rand['descriere'] . '</td> 
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
		...
		$cerereSQLhtml = mysqli_query($conexiune, 'SELECT * FROM `html` WHERE aprove="Yes" ORDER BY `id` DESC LIMIT 5');

		echo '<br><h5 align="left">:: Last 5 HTML Tutorials Added</h5>';
		echo '<table border=0 cellspacing="2" cellpadding="2" width="90%" align="center">';

		while ($rand = mysqli_fetch_assoc($cerereSQLhtml)) {
			$width = $rand['rd'] * 10;
			echo '<tr>
<td width="40" height="40" rowspan="2" class="display"><img src="' . $siteurl . '/images/html.gif" width="40" height="40"></td>
<td colspan="2" class="display"><b><a href="' . $siteurl . '/html_tutorial.php?id=' . $rand['id'] . '" target="_blank">' . $rand['title'] . '</a></b> - ' . $rand['descriere'] . '</td> 
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
		...
		$cerereSQLps = mysqli_query($conexiune, 'SELECT * FROM `ps` WHERE aprove="Yes" ORDER BY `id` DESC LIMIT 5');

		echo '<br><h5 align="left">:: Last 5 Photoshop Tutorials Added</h5>';
		echo '<table border=0 cellspacing="2" cellpadding="2" width="90%" align="center">';

		while ($rand = mysqli_fetch_assoc($cerereSQLps)) {
			$width = $rand['rd'] * 10;
			echo '<tr>
<td width="40" height="40" rowspan="2" class="display"><img src="' . $rand['banner'] . '" width="40" height="40"></td>
<td colspan="2" class="display"><b><a href="' . $siteurl . '/ps_tutorial.php?id=' . $rand['id'] . '" target="_blank">' . $rand['title'] . '</a></b> - ' . $rand['descriere'] . '</td> 
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
		...
		$cerereSQLphp = mysqli_query($conexiune, 'SELECT * FROM `php` WHERE aprove="Yes" ORDER BY `id` DESC LIMIT 5');

		echo '<br><h5 align="left">:: Last 5 PHP Tutorials Added</h5>';
		echo '<table border=0 cellspacing="2" cellpadding="2" width="90%" align="center">';

		while ($rand = mysqli_fetch_assoc($cerereSQLphp)) {
			$width = $rand['rd'] * 10;
			echo '<tr>
<td width="40" height="40" rowspan="2" class="display"><img src="' . $siteurl . '/images/php.gif" width="40" height="40"></td>
<td colspan="2" class="display"><b><a href="' . $siteurl . '/php_tutorial.php?id=' . $rand['id'] . '" target="_blank">' . $rand['title'] . '</a></b> - ' . $rand['descriere'] . '</td> 
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
	...
	case 'css';
		...
		$rezultate_maxime = 25;
		$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT `id` FROM `css` WHERE aprove="Yes"'));
		...
		if ($intrari_totale == 0) echo 'No CSS Tutorials Yet...';
			...
			$cerereSQL = mysqli_query($conexiune, 'SELECT * FROM `css` WHERE aprove="Yes" ORDER by ' . $_SESSION['sort'] . ' ' . $_SESSION['fel'] . ' LIMIT ' . $from . ', ' . $rezultate_maxime . ' ');
			$pagini_totale = ceil($intrari_totale / $rezultate_maxime);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
	...
	case 'html';
		...
		$rezultate_maxime = 25;
		$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT `id` FROM `html` WHERE aprove="Yes"'));
		...
		if ($intrari_totale == 0) echo 'No HTML Tutorials Yet...';
			...
			$cerereSQL = mysqli_query($conexiune, 'SELECT * FROM `html` WHERE aprove="Yes" ORDER by ' . $_SESSION['sort'] . ' ' . $_SESSION['fel'] . ' LIMIT ' . $from . ', ' . $rezultate_maxime . ' ');
			$pagini_totale = ceil($intrari_totale / $rezultate_maxime);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
	...
	case 'php';
		...
		$rezultate_maxime = 25;
		$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT `id` FROM `php` WHERE aprove="Yes"'));
		...
		if ($intrari_totale == 0) echo 'No PHP Tutorials Yet...';
			...
			$cerereSQL = mysqli_query($conexiune, 'SELECT * FROM `php` WHERE aprove="Yes" ORDER by ' . $_SESSION['sort'] . ' ' . $_SESSION['fel'] . ' LIMIT ' . $from . ', ' . $rezultate_maxime . ' ');
			$pagini_totale = ceil($intrari_totale / $rezultate_maxime);
...
<td align="right" class="display" width="12%">Views : <b>' . $rand['hits'] . '</b></td>
	...
	case 'ps';
		...
		$rezultate_maxime = 25;
		$intrari_totale = mysqli_num_rows(mysqli_query($conexiune, 'SELECT `id` FROM `ps` WHERE aprove="Yes"'));
		...
		if ($intrari_totale == 0) echo 'No PHOTOSHOP Tutorials Yet...';
			...
			$cerereSQL = mysqli_query($conexiune, 'SELECT * FROM `ps` WHERE aprove="Yes" ORDER by ' . $_SESSION['sort'] . ' ' . $_SESSION['fel'] . ' LIMIT ' . $from . ', ' . $rezultate_maxime . ' ');
			$pagini_totale = ceil($intrari_totale / $rezultate_maxime);
