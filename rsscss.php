...
$feedTitle = "Latest CSS Tutorials Added";
$rssVersion = 2.0;
...
$query = "SELECT * FROM `css` WHERE `aprove`='Yes' ORDER BY `id` DESC LIMIT 10";
// execute the query
...
$rss .= "<link>http://tutorials.vufu.net/css_tutorial.php?id=" . $row['id'] . "</link>\r\n";
